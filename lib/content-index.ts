...
import topik0 from "@/content/dasar/das-kuadrat.json";
import topik1 from "@/content/dasar/das-linear.json";
import topik2 from "@/content/menengah/alj-eksponen-logaritma.json";
import topik3 from "@/content/menengah/alj-nilai-mutlak.json";
import topik4 from "@/content/menengah/kal-limit-aljabar.json";
import topik5 from "@/content/lanjut/lan-integral-tentu.json";
import topik6 from "@/content/olimpiade/osn-keterbagian.json";
